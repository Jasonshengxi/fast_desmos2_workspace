    ...
    pub fn add_attr(&mut self, attr_type: AttrType, component_count: u32) {
        ...
        unsafe {
            match attr_type.function_to_use() {
                GlVertexFormatFunc::Float => gl::VertexArrayAttribFormat(
                    self.vertex_array.as_handle(),
                    attr_index,
                ...
                GlVertexFormatFunc::Int => gl::VertexArrayAttribIFormat(
                    self.vertex_array.as_handle(),
                    attr_index,
                    component_count as i32,
                    attr_type.to_u32(),
                ...
                GlVertexFormatFunc::Long => gl::VertexArrayAttribLFormat(
                    self.vertex_array.as_handle(),
                    attr_index,
                    component_count as i32,
                    attr_type.to_u32(),
